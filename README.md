...
Transform [Beneficial Ownership Data Standard (BODS) v0.4](https://standard.openownership.org/en/0.4.0/) data into [Google AML AI](https://cloud.google.com/financial-services/anti-money-laundering) input format.
